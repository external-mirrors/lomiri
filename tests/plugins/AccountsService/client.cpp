...
private Q_SLOTS:
    ...
    void testInvalids()
    {
        ...
        QCOMPARE(session.getUserPropertyAsync("NOPE", "com.ubports.lomiri.AccountsService", "DemoEdges2").value(), QVariant());
        QCOMPARE(session.getUserPropertyAsync(QTest::currentTestFunction(), "com.ubports.lomiri.AccountsService", "NOPE").value(), QVariant());
    }

    void testGetSetServiceDBusAdaptor()
    {
        AccountsServiceDBusAdaptor session;
        session.setUserPropertyAsync(QTest::currentTestFunction(), "com.ubports.lomiri.AccountsService", "DemoEdges2", QVariant(true)).waitForFinished();
        QCOMPARE(session.getUserPropertyAsync(QTest::currentTestFunction(), "com.ubports.lomiri.AccountsService", "DemoEdges2").value(), QVariant(true));
        session.setUserPropertyAsync(QTest::currentTestFunction(), "com.ubports.lomiri.AccountsService", "DemoEdges2", QVariant(false)).waitForFinished();
        QCOMPARE(session.getUserPropertyAsync(QTest::currentTestFunction(), "com.ubports.lomiri.AccountsService", "DemoEdges2").value(), QVariant(false));
    }
    ...
    void testAsynchronousChangeForDemoEdgesCompleted()
    {
        ...
        ASSERT_DBUS_CALL(m_userInterface->call("Set",
                                               "com.ubports.lomiri.AccountsService",
                                               "DemoEdgesCompleted",
    ...
    void testAsynchronousChangeForFailedLogins()
    {
        ...
        ASSERT_DBUS_CALL(m_userInterface->asyncCall("Set",
                                                    "com.ubports.lomiri.AccountsService.Private",
                                                    "FailedLogins",
                                                    dbusVariant(5)));
