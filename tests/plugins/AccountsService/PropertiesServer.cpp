...
void PropertiesServer::internalSet(const QString &interface, const QString &property, const QVariant &variant)
{
    ...
    if (m_properties[interface].contains(property)) {
        ...
        if (oldValue != newValue) {
            ...
            if (interface == QStringLiteral("com.ubports.lomiri.AccountsService") &&
...
{
    m_properties["com.ubports.lomiri.AccountsService"]["DemoEdges2"] = false;
    m_properties["com.ubports.lomiri.AccountsService"]["DemoEdgesCompleted"] = QStringList();
    m_properties["com.ubports.lomiri.AccountsService"]["LauncherItems"] = QVariant::fromValue(QList<QVariantMap>());
    m_properties["com.ubports.lomiri.AccountsService.Private"]["FailedLogins"] = 0;
    ...
    m_properties["com.lomiri.location.providers.here.AccountsService"]["LicenseAccepted"] = false;
    m_properties["com.lomiri.location.providers.here.AccountsService"]["LicenseBasePath"] = "";
