...
GSettingsControllerQml::GSettingsControllerQml()
    ...
    , m_launcherWidth(8)
    , m_sideStageWidth(1.0)
    , m_indicatorMenuWidth(1.0)
    , m_edgeDragWidth(2)
...
double GSettingsControllerQml::sideStageWidth() const
{
    return m_sideStageWidth;
}

void GSettingsControllerQml::setSideStageWidth(double sideStageWidth)
{
...
double GSettingsControllerQml::indicatorMenuWidth() const
{
    return m_indicatorMenuWidth;
}

void GSettingsControllerQml::setIndicatorMenuWidth(double indicatorMenuWidth)
{
...
{
    if (m_valid && m_schema->id() == "com.lomiri.Shell.Greeter") {
...
{
    if (m_valid && m_schema->id() == "com.lomiri.Shell") {
        GSettingsControllerQml::instance()->setSideStageWidth(sideStageWidth.toDouble());
    }
}
...
{
    if (m_valid && m_schema->id() == "com.lomiri.Shell") {
        GSettingsControllerQml::instance()->setIndicatorMenuWidth(indicatorMenuWidth.toDouble());
    }
}
