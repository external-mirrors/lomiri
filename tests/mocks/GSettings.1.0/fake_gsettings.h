...
public:
    ...
    double sideStageWidth() const;
    Q_INVOKABLE void setSideStageWidth(double sideStageWidth);

    double indicatorMenuWidth() const;
    Q_INVOKABLE void setIndicatorMenuWidth(double indicatorMenuWidth);
...
Q_SIGNALS:
    ...
    void sideStageWidthChanged(double sideStageWidth);
    void indicatorMenuWidthChanged(double indicatorMenuWidth);
...
private:
    ...
    int m_launcherWidth;
    double m_sideStageWidth;
    double m_indicatorMenuWidth;
