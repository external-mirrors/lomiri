...
function(install_test_script TARGET_NAME)
    ...
    string(REPLACE \"${CMAKE_BINARY_DIR}/plugins\" \"${SHELL_INSTALL_QML}\" replacestr \"\${replacestr}\")
    string(REPLACE \"${CMAKE_BINARY_DIR}/tests/libs\" \"${SHELL_PRIVATE_FULL_LIBEXECDIR}/tests/libs\" replacestr \"\${replacestr}\")
    string(REPLACE \"${CMAKE_BINARY_DIR}/tests/mocks\" \"${SHELL_INSTALL_QML}/mocks\" replacestr \"\${replacestr}\")
    ...
    string(REPLACE \"${CMAKE_BINARY_DIR}/tests/utils/modules\" \"${SHELL_INSTALL_QML}/utils\" replacestr \"\${replacestr}\")
