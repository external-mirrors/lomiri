...
QtObject {
    ...
    readonly property alias supportsRebootToRecovery: priv.supportsRebootToRecovery
    ...
    readonly property var priv: StateGroup {
        ...
        property bool supportsRebootToRecovery: deviceConfig.supportsRebootToRecovery
