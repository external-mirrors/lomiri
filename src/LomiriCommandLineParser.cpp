...
LomiriCommandLineParser::LomiriCommandLineParser(const QCoreApplication &app)
{
...
int LomiriCommandLineParser::parsePixelsValue(const QString &str)
{
...
float LomiriCommandLineParser::getenvFloat(const char* name, float defaultValue)
{
...
void LomiriCommandLineParser::resolveMode(QCommandLineParser &parser, QCommandLineOption &modeOption)
{
